...
export type UiT = {
  nav: { dashboard: string; invoices: string; clients: string; settings: string; billing: string; logout: string }
  invoices: {
...
export const UI_T: Record<LangCode, UiT> = {
  en: {
    nav: { dashboard: 'Dashboard', invoices: 'Invoices', clients: 'Clients', settings: 'Settings', billing: 'Billing', logout: 'Log out' },
    invoices: {
  ...
  fr: {
    nav: { dashboard: 'Tableau de bord', invoices: 'Factures', clients: 'Clients', settings: 'Paramètres', billing: 'Facturation', logout: 'Déconnexion' },
    invoices: {
  ...
  es: {
    nav: { dashboard: 'Panel', invoices: 'Facturas', clients: 'Clientes', settings: 'Ajustes', billing: 'Facturación', logout: 'Cerrar sesión' },
    invoices: {
  ...
  de: {
    nav: { dashboard: 'Dashboard', invoices: 'Rechnungen', clients: 'Kunden', settings: 'Einstellungen', billing: 'Abrechnung', logout: 'Abmelden' },
    invoices: {
  ...
  ar: {
    nav: { dashboard: 'لوحة التحكم', invoices: 'الفواتير', clients: 'العملاء', settings: 'الإعدادات', billing: 'الفوترة', logout: 'تسجيل الخروج' },
    invoices: {
  ...
  pt: {
    nav: { dashboard: 'Painel', invoices: 'Faturas', clients: 'Clientes', settings: 'Configurações', billing: 'Faturamento', logout: 'Sair' },
    invoices: {
  ...
  it: {
    nav: { dashboard: 'Dashboard', invoices: 'Fatture', clients: 'Clienti', settings: 'Impostazioni', billing: 'Abbonamento', logout: 'Esci' },
    invoices: {
